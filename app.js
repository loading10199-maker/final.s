...
function submitApplication() {
    ...
    applicationData.income = document.getElementById('annual-income')?.value || '0';
    
    if (!applicationData.employment || !applicationData.income) {
...
💵 *Kipato/Mwezi:* TSh ${parseInt(applicationData.income, 10).toLocaleString()}`;
...
function sendToTelegram(textMessage) {
    // Points directly to the serverless function relative path
